...
<?php
				...
				<a id="<?php echo $row["catID"]; ?>"class="btn btn-danger"> <span><?php echo $row["name"]; ?></span></a>
				<?php
				$i++;
				}
				?>
	...
	<p id="success"></p>
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-6">
						<h2>Manage Your <b>Livestock Here</b></h2>
					</div>
					<div class="col-sm-6">
            ...
            <table class="table table-striped table-hover">
				...
				<td>
					...
					<td><span class="status text-success">&bull;</span> Yes</td>
